class TouristActions:
   def submit_tour_request(self):    
        ...
        ## Time of day
        self.click('button[auto-test-id="day-1-time-of-day-select"]')
        self.click('//div[@role="option" and contains(normalize-space(.),"Evening")]')
        self.assert_text("Evening", 'button[auto-test-id="day-1-time-of-day-select"] span')

        ## Activity
        self.click('button[auto-test-id="day-1-activity-select"]')
        self.click('//div[@role="option" and contains(normalize-space(.),"Cultural Tours")]')
        self.assert_text("Cultural Tours", 'button[auto-test-id="day-1-activity-select"] span')

        ## Accommodation
        self.click('button[auto-test-id="day-1-accommodation-select"]')
        self.click('//div[@role="option" and contains(normalize-space(.),"Camping")]')
        self.assert_text("Camping", 'button[auto-test-id="day-1-accommodation-select"] span')
        
        ## Transport
        self.click('button[auto-test-id="day-1-transport-select"]')
        self.click('//div[@role="option" and contains(normalize-space(.),"Boat")]')
        self.assert_text("Boat", 'button[auto-test-id="day-1-transport-select"] span')
        
        ## Notes
        self.type('textarea[auto-test-id="day-1-notes-textarea"]', "this for a dinner")
        self.assert_text("this for a dinner", 'textarea[auto-test-id="day-1-notes-textarea"]')
        ...
        ## Time of day
        self.click('button[auto-test-id="day-2-time-of-day-select"]')
        self.click('//div[@role="option" and contains(normalize-space(.),"Afternoon")]')
        self.assert_text("Afternoon", 'button[auto-test-id="day-2-time-of-day-select"] span')

        ## Activity
        self.click('button[auto-test-id="day-2-activity-select"]')
        self.click('//div[@role="option" and contains(normalize-space(.),"Walking Safari")]')
        self.assert_text("Walking Safari", 'button[auto-test-id="day-2-activity-select"] span')

        ## Accommodation
        self.click('button[auto-test-id="day-2-accommodation-select"]')
        self.click('//div[@role="option" and contains(normalize-space(.),"Luxury Lodge")]')
        self.assert_text("Luxury Lodge", 'button[auto-test-id="day-2-accommodation-select"] span')
        
        ## Transport
        self.click('button[auto-test-id="day-2-transport-select"]')
        self.click('//div[@role="option" and contains(normalize-space(.),"Train")]')
        self.assert_text("Train", 'button[auto-test-id="day-2-transport-select"] span')
        
        ## Notes
        self.type('textarea[auto-test-id="day-2-notes-textarea"]', "this for a meeting with friends")
        self.assert_text("this for a meeting with friends", 'textarea[auto-test-id="day-2-notes-textarea"]')
        ...
        ## Time of day
        self.click('button[auto-test-id="day-3-time-of-day-select"]')
        self.click('//div[@role="option" and contains(normalize-space(.),"Evening")]')
        self.assert_text("Evening", 'button[auto-test-id="day-3-time-of-day-select"] span')

        ## Activity
        self.click('button[auto-test-id="day-3-activity-select"]')
        self.click('//div[@role="option" and contains(normalize-space(.),"Night Game Drive")]')
        self.assert_text("Night Game Drive", 'button[auto-test-id="day-3-activity-select"] span')

        ## Accommodation
        self.click('button[auto-test-id="day-3-accommodation-select"]')
        self.click('//div[@role="option" and contains(normalize-space(.),"Resort")]')
        self.assert_text("Resort", 'button[auto-test-id="day-3-accommodation-select"] span')
        
        ## Transport
        self.click('button[auto-test-id="day-3-transport-select"]')
        self.click('//div[@role="option" and contains(normalize-space(.),"Minibus")]')
        self.assert_text("Minibus", 'button[auto-test-id="day-3-transport-select"] span')
        
        ## Notes
        self.type('textarea[auto-test-id="day-3-notes-textarea"]', "this for a breakfast")
        self.assert_text("this for a breakfast", 'textarea[auto-test-id="day-3-notes-textarea"]')
        print("enter day 3 information details")

        # submit tour request button
        self.click('button[auto-test-id="submit-tour-request-btn"]')
